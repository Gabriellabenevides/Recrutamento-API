...
namespace Recrutamento.API.Extensions.SwaggerConfigurations;
...
internal static class SwaggerConfig
{
    ...
    internal static IServiceCollection AddSwaggerConfig(this IServiceCollection services, IConfiguration configuration)
    {
        services.AddSwaggerGen(options =>
        {
            ...
            // Incluir comentários XML dos projetos referenciados que começam com "Recrutamento.Api"
            var referencedProjectsXmlDocPaths = executingAssembly.GetReferencedAssemblies()
                .Where(assembly => assembly.Name != null && assembly.Name.StartsWith("Recrutamento.Api", StringComparison.InvariantCultureIgnoreCase))
